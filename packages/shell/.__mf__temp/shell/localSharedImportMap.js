...
// Windows temporarily needs this file, https://github.com/module-federation/vite/issues/68
    ...
    const importMap = {
        ...
        "@chakra-ui/react": async () => {
          let pkg = await import("__mf__virtual/shell__prebuild___mf_0_chakra_mf_2_ui_mf_1_react__prebuild__.js");
            return pkg;
        }
      ,
        "@emotion/react": async () => {
      ...
      ,
        "framer-motion": async () => {
          let pkg = await import("__mf__virtual/shell__prebuild__framer_mf_2_motion__prebuild__.js");
            return pkg;
        }
      ,
        "react": async () => {
