...
// Windows temporarily needs this file, https://github.com/module-federation/vite/issues/68
    ...
    const importMap = {
        ...
        "@chakra-ui/react": async () => {
          let pkg = await import("__mf__virtual/dashboard__prebuild___mf_0_chakra_mf_2_ui_mf_1_react__prebuild__.js");
            return pkg;
        }
      ,
        "@emotion/react": async () => {
          let pkg = await import("__mf__virtual/dashboard__prebuild___mf_0_emotion_mf_1_react__prebuild__.js");
            return pkg;
        }
      ,
        "@emotion/styled": async () => {
          let pkg = await import("__mf__virtual/dashboard__prebuild___mf_0_emotion_mf_1_styled__prebuild__.js");
            return pkg;
        }
      ,
        "framer-motion": async () => {
          let pkg = await import("__mf__virtual/dashboard__prebuild__framer_mf_2_motion__prebuild__.js");
            return pkg;
        }
      ,
        "react": async () => {
      ...
      ,
        "react-router-dom": async () => {
          let pkg = await import("__mf__virtual/dashboard__prebuild__react_mf_2_router_mf_2_dom__prebuild__.js");
            return pkg;
        }
